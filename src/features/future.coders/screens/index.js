  ...
  return (
    <View style={globalStyles.container}>
      <View style={globalStyles.top}>
        <Text style={globalStyles.topText}>Register Child</Text>
        <Notification
          title="15"
            ...
            <View>
              ...
              <View>
                <Text style={{ margin: 10 }}>
                  we enrich the future generation through tech innovations in
                  our FutureCoders program of children aged 12 to 17. experience
                  closer, the next is yours!The next cohort starts on 5th
                  Jul2022.
                </Text>
              </View>
            </View>
